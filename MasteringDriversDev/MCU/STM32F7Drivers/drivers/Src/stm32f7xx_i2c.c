...
//	if(pI2CHandle->pI2Cx->ICR & ( 1 << I2C_SR2_MSL))
//	{
...
{
	pI2Cx->CR1 |= I2C_CR2_STOP;
}


 void I2C_SlaveEnableDisableCallbackEvents(I2C_REG_Def_t *pI2Cx,uint8_t EnorDi)
 {
//	 if(EnorDi == ENABLE)
//	 {
 ...
 */
 ...
 void I2CPeripheralControl(I2C_REG_Def_t *I2Cx,uint8_t Activation)
{
 ...
 * @Note              -
 */
void I2C_PeriClockControl(I2C_REG_Def_t *pI2Cx, uint8_t Activation)
{
	if(Activation == ENABLE)
	{
		if(pI2Cx == I2C1)
...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
   ...
   //program the device own address
	...
	tempreg = 0;
	if(pI2CHandle->I2C_Config.I2C_SCL_Speed <= SCL_SPEED_STANDARD)
	{
...
void I2C_MasterSendData(I2C_Handle_t *pI2CHandle,uint8_t *pTxbuffer, uint32_t Len, uint8_t SlaveAddr,uint8_t Sr)
{
	...
	while( !  I2C_GetFlagStatus(pI2CHandle->pI2Cx,I2C_CR1_SBC)   );
	...
	while(Len > 0)
	{
		while(! I2C_GetFlagStatus(pI2CHandle->pI2Cx,I2C_ISR_TXE) ); //Wait till TXE is set
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle,uint8_t *pRxBuffer, uint8_t Len, uint8_t SlaveAddr,uint8_t Sr)
{
	...
	{
		//Disable Acking
		I2C_ManageAcking(pI2CHandle->pI2Cx,ACK_CONTROL_DIS);
		...
		while(! I2C_GetFlagStatus(pI2CHandle->pI2Cx,I2C_ISR_RXNE) );
	...
	//re-enable ACKing
	if(pI2CHandle->I2C_Config.I2C_AckControl == ACK_CONTROL_EN)
	{
		I2C_ManageAcking(pI2CHandle->pI2Cx,ACK_CONTROL_EN);
	}
...
void I2C_SlaveSendData(I2C_REG_Def_t *pI2C,uint8_t data)
{
	pI2C->TXDR = data;
}

uint8_t I2C_SlaveReceiveData(I2C_REG_Def_t *pI2C)
{
