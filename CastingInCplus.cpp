...
class MyDerived : public MyBase 
{
    ...
    void TestDerived()
    {
        cout<< "Testing Derived additional method";
    }
    */
};
...
int main() {
    ...
    //if we change this to dynamic_cast it will not compile
    MyDerived* md4 = static_cast<MyDerived*>(mb3);

    cout << "The type of md3 is " << typeid(mb3).name() << endl;
     cout << "The type of md4 is " << typeid(md4).name() << endl;
